...
import { Github, ExternalLink, Mail, Linkedin, Terminal, Code, Folder } from 'lucide-react';
            ...
            <main className="max-w-6xl mx-auto px-4 pt-24">
                ...
                <section className="min-h-screen flex flex-col justify-center">
                    ...
                    <div className={`transform transition-all duration-1000 ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                        ...
                        <h1 className="text-5xl md:text-5xl font-bold text-gray-100 mb-4">Priyanshu Mishra.</h1>
                ...
                <section id="about" className="py-20">
                    <div className="max-w-3xl">
                        ...
                        <div className="text-gray-400 space-y-4">
                            <p>
                                Hi! I'm Priyanshu, a passionate third-semester engineering student
                                who loves bringing ideas to life on the web. My journey into web development
                                began just last year, and it’s been an exciting ride of learning and creating
                                ever since!
                            </p>
                            <p>
                                From building projects that solve real-world problems to collaborating in hackathons,
                                I’ve embraced every opportunity to grow as a developer. These experiences have not
                                only sharpened my technical skills but also fueled my curiosity to explore new tools
                                and technologies.
                                Right now, I’m focused on crafting functional, user-friendly web experiences and
