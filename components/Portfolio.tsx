...
import { Github, ExternalLink, Mail, Linkedin, Folder, Menu, X } from "lucide-react"
...
const Portfolio: React.FC = () => {
  ...
  const otherProjects = [
    ...
    },
    {
      ...
      external: "https://krishi-marketplace.vercel.app/",
    },
    {
      title: "Portfolio v1",
      ...
      external: "https://alokk.vercel.app/",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-300">
      {/* Navigation */}
      <nav className="w-full bg-gray-900/90 backdrop-blur-sm z-50">
        <div className="max-w-6xl mx-auto px-4 py-5">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <Image src="/profile-pic.jpg" alt="Your Name" width={145} height={145} className="rounded-full" />
            </div>
            <div className="md:hidden relative">
              <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-gray-400 hover:text-green-400 p-2">
      ...
      <main className="max-w-6xl mx-auto px-4 pt-24">
        ...
        <section className="min-h-screen flex items-center">
          ...
          >
            ...
            <p className="max-w-xl text-gray-400 mb-12">
              I&apos;m a software engineer specializing in building exceptional digital experiences. Currently, I&apos;m
        ...
        <section id="about" className="py-20">
          <div className="max-w-3xl">
            ...
            <div className="text-gray-400 space-y-4">
              <p>
                Hi! I am Priyanshu, a passionate 4th-semester engineering student who loves bringing ideas to life on
                the web. My journey into web development began just last year, and it is been an exciting ride of
                learning and creating ever since!
              </p>
              <p>
                From building projects that solve real-world problems to collaborating in hackathons, I have embraced
                every opportunity to grow as a developer. These experiences have not only sharpened my technical skills
                but also fueled my curiosity to explore new tools and technologies. Right now, I am focused on crafting
                functional, user-friendly web experiences and discovering the endless possibilities of coding.
              </p>
        ...
        <section id="experience" className="py-20">
          ...
          <div className="max-w-3xl">
            {experiences.map((exp, index) => (
              <div key={index} className="mb-12 transform hover:-translate-x-2 transition-transform duration-300">
          ...
          <div className="space-y-20">
            {featuredProjects.map((project, index) => (
              <div key={index} className="relative group">
                <div
                  className="relative z-10 bg-gray-800/90 p-6 md:p-8 rounded-lg backdrop-blur-sm
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-3 mb-6">
                    {project.tech.map((tech, i) => (
                      <span key={i} className="text-green-400 text-sm font-mono">
                        {tech}
                      </span>
                    ))}
                  </div>
        ...
        <section id="contact" className="py-20 text-center">
          ...
          <div className="flex justify-center space-x-6 mb-12">
            <a
              href="https://www.github.com/prime64m"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/priyansh64"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-green-400"
            >
            ...
            <a
              href="https://www.instagram.com/priyansh.64"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-green-400"
            >
